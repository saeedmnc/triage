...
export var lineChartLabels: Array<any> = ['January', 'February', 'March', 'April', 'May', 'June', ' خرداد'];
...
export var areaChartLabels: Array<any> = ['January', 'February', 'March', 'April', 'May', 'June', ' خرداد'];
...
export var scatterChartLabels: Array<any> = ['January', 'February', 'March', 'April', 'May', 'June', ' خرداد'];
